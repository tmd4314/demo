...
const CCTV3 = () => {
  ...
  const handleVideoPlay = () => {
    ...
    if (videoElement) {
      if (Hls.isSupported()) {
        const hls = new Hls();
        hls.loadSource('https://hallacctv.kr/live/cctv03.stream_360p/playlist.m3u8');
        hls.attachMedia(videoElement);
        hls.on(Hls.Events.MANIFEST_PARSED, function () {
          videoElement.play();
        });
      } else if (videoElement.canPlayType('application/vnd.apple.mpegurl')) {
        videoElement.src = 'https://hallacctv.kr/live/cctv03.stream_360p/playlist.m3u8';
    ...
    <div className="container">
      <div className="row">
        <div className="col-sm-3">
          <div className="alert alert-info menu-title">실시간 CCTV(윗세오름)
              <ul id="sources" className="urls list-unstyled">
                ...
                <li className="url active"><a href="/user/cctv3">윗세오름</a></li>
