...
const MapWithPanoramaAndRoute = () => {
    ...
    useEffect(() => {
        const initializePanorama = () => {
            const panoramaOptions = {
                ...
                position: new navermaps.LatLng(33.384800, 126.618999),
                pov: {
                    pan: -135,
                    tilt: 29,
                    fov: 100
    ...
    const points = [
        { lat: 33.384800, lng: 126.618999 },
        // Add more points here as needed
        { lat: 33.380000, lng: 126.581381 },
        { lat: 33.373330, lng: 126.568600 },
        { lat: 33.369430, lng: 126.555590 },
        ...
        <div>
            ...
            >
                ...
                <NaverMap
                    ...
                    defaultCenter={new navermaps.LatLng(33.372633, 126.572627)}
                    defaultZoom={14}
                >
            ...
            <p>총 9.6㎞ [성판악→진달래밭(7.3㎞)→동능정상(9.6㎞)]
               ...
               주의사항> 탐방로가 길고 산행 난이도가 높아 하산 시 다리골절이나 체력소모로 인한 탈진 등의 안전사고가 발생될 수 있으므로 그룹탐방을 하는 것이 좋으며, 특히 동절기는 해가 짧아져 하산시 안전사고의 위험이 높아지므로 어두워지기 전에 서둘러 산행을 마무리 할 수 있도록 각별히 주의를 기울여야 한다.
               ...
               매     점 : 성판악탐방로 전구간은 매점이 없으므로 사전에 산행에 필요한 물품(식수, 간단한 먹거리 등)은 철저히 준비하여 주시기 바랍니다.
               화 장 실 : 성판악사무실, 속밭대피소, 진달래밭대피소
               교     통 : 제주시 시외버스터미널에서 서귀포 방면(516도로-간선281/ 직행181) 시외버스 이용(40분) 입구에서 내려 2분쯤 걸으면 성판악 탐방로가 있다. 성판악탐방로는 주차장이 협소하여 성수기에는 탐방시간 시작 전에 만차가 되는 경우가 많으므로 반드시 대중교통을 이용하여 주시기 바랍니다.
               대중교통 281번, 181번 버스운영 시간 -> 제주버스정보시스템 http://bus.jeju.go.kr/ 을 통해 쉽게 알아 볼 수 있다.
               기타 문의 : 한라산국립공원관리소  064)713-9950~1 / 성판악지소  064)725-9950</p>
        </div>
    );
};
